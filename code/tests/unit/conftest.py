...
@fixture(scope='session')
def jwks_host_response(test_keys_and_token):
    return test_keys_and_token["jwks"]


@fixture(scope='session')
def wrong_jwks_host_response(test_keys_and_token):
    return test_keys_and_token["wrong_jwks"]
